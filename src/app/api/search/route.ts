...
export async function GET(request: Request) {
  ...
  const data = await getCatalogProducts(locale, { limit: 6, search: query, includePrices: true, priceTier: pricing.priceTier, discountPercent: pricing.discountPercent });
